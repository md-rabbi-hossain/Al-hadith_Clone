...
export const Bookcard = () => {
  return (
    <div className="">
      <div className="col-start-1 hidden xl:block fixed w-[350px] lg:w-full">
        <div className="rounded-2xl h-[calc(100vh_-_115px)] bg-white flex items-center flex-col lg:w-[350px] md:w-full">
          <Category />
          <div className="w-full h-[50px]">
            <div className="relative px-4 -pr-6 my-3">
              ...
              <input
                ...
                className="mt-2 bg-custombg dark:bg-darkchapter-list-hover w-full text-hadith-offblack p-3 rounded-lg focus:outline-0 focus:text-black dark:text-hadith-deepoffwhite pl-10 pr-10"
                type="text"
              ></input>
            </div>
          </div>
          <div className="pl-4 w-full overflow-y-scroll lg:h-[calc(100vh-200px)] lg:pb-10 pr-1.5 mr-1.5 mt-10">
            {ChapterData.map((item, index) => (
              <div
                ...
                className={`p-4 mb-10 mt-4 flex cursor-pointer bg-white hover:bg-[#ebfcf6] justify-between items-center rounded-2xl h-[6.25rem] ${
                  index === 0 ? "bg-[#ebfcf6] " : "" // Apply special style to the first item
                }`}
              >
                <div className="flex items-center gap-4">
                  <div className="h-12 w-12 sm-max:w-10 xl:w-10 flex items-center justify-center relative">
                    <h3 className="text-customGreen absolute md:text-base text-xl font-medium xl:text-lg">
                      {item.chapternumber}
                    </h3>
                  </div>
                  <div className="flex flex-col justify-between gap-1.5">
                    <h4 className="text-black dark:text-hadith-deepoffwhite style-Kalpurush max-line-2">
                      {item.name}
                    </h4>
